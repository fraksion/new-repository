...
//        deleteModels();
    ...
    function generateHTMLInput(data){
        ...
        for (var i=0; i<data.length; i++){
            ...
            $('<p><input class="inputValues" style="border: none; outline: none;" type="number" value= "' + valueArray[0] + '" type="number" step="0.001" min="' + minAndMaxValues[i].min + '" max="' + minAndMaxValues[i].max + '" " id="first-input-test' + i + '"> <label id="first-input-label' + i + '">'+ valueArray[1] + '</label> </p>').appendTo(list);
